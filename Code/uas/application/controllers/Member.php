...
class Member extends CI_Controller
{
            ...
            if ($user['is_active'] == 1) {
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    if ($inputcaptcha == $sesscaptcha) {
                        ...
                        $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-message" role="alert">Captcha salah</div>');
                        redirect('home');
                    }
                } else {
    ...
    public function daftar()
    {
        ...
        if ($inputcaptcha == $sesscaptcha) {
            ...
            $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-message" role="alert">Selamat!! akun anggota anda sudah dibuat. Silahkan Login</div>');
            redirect('home');
        } else {
            $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-message" role="alert">Captcha Salah</div>');
            redirect('home');
