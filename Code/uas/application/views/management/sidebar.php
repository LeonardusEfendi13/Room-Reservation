...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <!-- Sidebar - Brand -->
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('management'); ?>">
  ...
  <li class="nav-item active">
    <a class="nav-link" href="<?= base_url('management'); ?>"><i class="fas fa-fw fa-tachometer-alt"></i><span>Dashboard</span></a>
  </li>
